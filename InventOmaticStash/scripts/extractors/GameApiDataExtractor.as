package extractors
{
   ...
   public class GameApiDataExtractor
   {
      ...
      private static var GAME_API_METHODS:Array = ["AccountInfoData","ActiveEmoteData","BabylonAvailableMapsData","BabylonData","BabylonUIData","CameraScopeData","CampSlotsData","CampVendingOfferData","CardPacksUIData","ChallengeCompleteData","ChallengeData","ChallengeTrackerData","ChallengeTrackerUpdateData","CharacterCardData","CharacterInfoData","CharacterNameData","CompassData","ContainerOptionsData","ControlMapData","ConversationHistoryData","CreditsMenuShuttle","CurrencyData","DailyOpsModalData","DamageNumberUIData","DeathData","DeathReviveData","DefaultMenuListData","DialogueData","EndOfMatchUIData","ExpeditionLocationsData","FanfareData","FanfareQuestAcceptData","FireForgetEvent","FriendsContextMenuData","FriendsListDataCold","FriendsListDataHot","FrobberData","GameStatePromptData","HelpMenuShuttle","HitIndicators","HubMenuShuttle","HUDColors","HUDMessageProvider","HUDModeData","HUDRightMetersData","HUDVOFlyoutData","InventoryItemCardData","ItemLevelEligibilityData","KeypadInfoData","LegendaryPerksMenuData","LobbyMenuList","LoginInfoData","LoginResponseData","MainMenuListData","MapMenuData","MapMenuFlyoutData","MenuStackData","MotdData","MyOffersData","OtherInventoryData","OtherInventoryTypeData","PartyMenuList","PerkCardGameModeFilterUIData","PerksUIData","PhotoGalleryData","PlayerStatsUIData","PlayMenuListData","PowerArmorInfoData","PublicTeamsData","PurchaseCompleteData","PVPData","PVPScoreEventData","QuestEventData","QuestTrackerData","QuestTrackerProvider","QuickPlayMenuData","RadialMenuActiveEffectListData","RadialMenuExpandMeterData","RadialMenuStateData","RecentActivitiesData","RecentActivityNavigateData","RecentPlayersListDataCold","RecentPlayersListDataHot","ReconMarkerData","ReputationData","ScoreboardData","ScoreboardFilterData","ScreenResolutionData","SeasonData","SeasonRewardClaimedFlyoutData","SeasonWidgetData","ServerPromptData","SocialMenuData","SocialMenuNavigateData","SocialNotificationData","SpeakerNamePosData","SplashData","StoreAtomPackData","StoreCategoryData","StoreMenuData","TargetData","TeamMarkers","TextInputData","TheirOffersData","TutorialModalData","UpdateRankData","VoiceChatAreaData","WorkshopBudgetData","WorkshopButtonBarData","WorkshopCategoryData","WorkshopConfigData","WorkshopEditModeData","WorkshopItemCardData","WorkshopMarkers","WorkshopMessageData","WorkshopStateData","WorldData"];
