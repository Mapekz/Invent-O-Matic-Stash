package extractors
{
   ...
   public class GameApiDataExtractor
   {
      ...
      private static var GAME_API_METHODS:Array = ["AccountInfoData","ActiveEmoteData","AthenaData","AthenaDetailsData","AthenaEditSettingsData","AthenaImagesData","AthenaNavigateData","BabylonAvailableMapsData","BabylonBleedoutUIData","BabylonCenterPrintData","BabylonCombatFeedUIData","BabylonData","BabylonItemUIData","BabylonSpectatorHUDUIData","BabylonUIData","BestBuildFlyoutData","BrahminNameData","BuildDynamicData","BuildStaticData","CameraScopeData","CampSlotsData","CampVendingOfferData","CardPacksUIData","CasinoData","ChallengeCompleteData","ChallengeData","ChallengeTrackerData","ChallengeTrackerUpdateData","CharacterCardData","CharacterInfoData","CharacterListData","CharacterMenuListData","CharacterNameData","CompassData","ContainerOptionsData","ControlMapData","ConversationHistoryData","CreditsMenuShuttle","CurrencyData","CustomerSupportData","DailyOpsModalData","DamageNumberUIData","DeathData","DeathReviveData","DefaultMenuListData","DeleteCharacterData","DialogueData","EncounterHealthMeterArray"
      ,"EndOfMatchUIData","ExamineMenuMode","ExpeditionLocationsData","ExpeditionsPostMatchData","ExternalPurchaseItemData","FanfareData","FanfareQuestAcceptData","FireForgetEvent","FriendsContextMenuData","FriendsListDataCold","FriendsListDataHot","FrobberData","GameStatePromptData","HelpMenuShuttle","HitIndicators","HotMapMarkerData","HubMenuShuttle","HUDColors","HUDMessageProvider","HUDModeData","HUDRightMetersData","HUDVOFlyoutData","ImageFixtureManagerData","InventoryItemCardData","InvitePlayerMenuData","ItemLevelEligibilityData","KeypadInfoData","LegendaryPerksMenuData","LobbyMenuList","LoginInfoData","LoginLegalData","LoginResponseData","LoginSpinnerData","MainMenuListData","MapMenuData","MapMenuDataChanges","MapMenuFlyoutData","MenuStackData","MessageEvents","MotdData","MyOffersData","NewPlayerLoadoutsData","OtherInventoryTypeData","PartyMenuList","PerkCardGameModeFilterUIData","PerksUIData","PetGiftFlyoutData","PhotoGalleryData","PhotoInfoDynamicData","pingArray","PlayerStatsUIData","PlayMenuListData"
      ,"PlayMenuOptionsData","PowerArmorInfoData","ProximityTrackersProvider","PublicTeamsData","PurchaseCompleteData","PVPData","PVPScoreEventData","QuestEventData","QuestTrackerData","QuestTrackerProvider","QuickPlayMenuData","RadialMenuActiveEffectListData","RadialMenuExpandedListData","RadialMenuExpandMeterData","RadialMenuListData","RadialMenuStateData","RadialMenuStatus","RecentActivitiesData","RecentActivityNavigateData","RecentPlayersListDataCold","RecentPlayersListDataHot","ReconMarkerData","ReputationData","ScoreboardData","ScoreboardFilterData","ScreenResolutionData","SeasonData","SeasonRewardClaimedFlyoutData","SeasonWidgetData","ServerPromptData","ServiceStaticData","SettingsInfoData","SharedPerksUIData","SocialMenuData","SocialMenuNavigateData","SocialNotificationData","SpeakerNamePosData","SpecialBuildsData","SpeechToTextData","SplashData","StoreAtomPackData","StoreBrowserImage","StoreCategoryData","StoreFilters","StoreItemData","StoreMenuData","StorePageData","TargetData","TeamMarkers"
      ,"TextInputData","TheirOffersData","TutorialModalData","UniversalRewardData","UniversalRewardsItemCard","UpdateRankData","VendingHistoryInfoData","VoiceChatAreaData","WorkshopBlueprintData","WorkshopBudgetData","WorkshopButtonBarData","WorkshopCategoriesData","WorkshopCategoryData","WorkshopConfigData","WorkshopEditModeData","WorkshopItemCard","WorkshopItemCardData","WorkshopItemsData","WorkshopMarkers","WorkshopMessageData","WorkshopStateData","WorkshopStatusData","WorkshopUpdateCategory","WorkshopUpdateItem","WorkshopVariantsData","WorldData"];
