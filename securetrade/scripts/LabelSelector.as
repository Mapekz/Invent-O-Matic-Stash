package
{
   ...
   public class LabelSelector extends BSUIComponent
   {
      ...
      private var MaxDisplayWidth:Number = 0;
      ...
      {
         this.m_UseMiddleAsCenter = param1;
      }
      ...
      public function Finalize(param1:Boolean = true) : *
      {
         ...
         while(_loc2_ < this.LabelsA.length)
         {
            ...
            this.TotalWidth += this.LabelsA[_loc2_].maxWidth;
            _loc2_++;
         }
      ...
      public function GetLeftIndex(param1:int) : *
      {
         ...
         if(this.m_MaxVisible == 3 && this.m_UseMiddleAsCenter)
         {
            if(param1 == this.LabelsA.length - 1)
            {
               return Math.max(param1 - 2,0);
            }
            return Math.max(param1 - 1,0);
         }
         if(param1 < _loc3_ || this.m_UseMiddleAsCenter && param1 + _loc2_ <= this.m_MaxVisible)
         {
            return 0;
         }
         if(param1 < this.LabelsA.length - _loc2_)
         {
            if(this.m_UseMiddleAsCenter)
            {
               return Math.max(param1 - _loc2_,0);
            }
            return Math.max(param1 - _loc3_,0);
         }
      ...
      public function SelectPrevious(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = int(this.SelectedIndex - 1);
            while(_loc2_ > -1)
            {
      ...
      {
         return -param1 * this.LabelsA[0].maxWidth;
      }
      ...
      private function GetCenteredOffsetForLeftIndex(param1:uint) : *
      {
         ...
         return this.GetOffsetForLeftIndex(param1) + this.m_CenterPointOffset - _loc2_ / 2;
      }
      ...
      public function UpdateSelector(param1:Number) : *
      {
         ...
         if(this.AnimationFramesLeftSelector > 0)
         {
            ...
            this.Selector_mc.x += _loc4_ * _loc2_;
            if(this.SelectorGray_mc != null)
            {
               this.SelectorGray_mc.x += _loc4_ * _loc2_;
            }
            this.AnimationFramesLeftSelector -= _loc2_;
      ...
      public function UpdateSlider(param1:Number) : *
      {
         ...
         if(this.AnimationFramesLeftSlider > 0)
         {
            ...
            _loc4_ = _loc3_ / this.AnimFrameCount;
            this.Slider_mc.x += _loc4_ * _loc2_;
            this.AnimationFramesLeftSlider -= _loc2_;
